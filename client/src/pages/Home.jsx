...
const Home = ({ isLoggedIn, login, openLogin, openRegister }) => {
  ...
  useEffect(() => {
    ...
    } else if (otpTimer === 0 && forgotStep === 2) {
      // 👈 Jab timer zero ho jaye aur user OTP wale step par ho
    ...
    <div className="home-page overflow-x-hidden">
        ...
        <div className="home-container hero-layout fade-in">
          <div className="hero-text-side">
            ...
            <p className="hero-desc-text">
              Revolutionizing technical hiring with real-time GitHub
              verification & AI-powered ATS auditing. Build proof, not just
              profiles.
            </p>
            <div className="hero-btn-group">
              ...
              <Link to="/about" className="nav-link font-bold text-accent">
                Learn More &rarr;
              </Link>
            </div>
          </div>
        ...
        <div className="home-container">
          <div className="text-center mb-12">
            ...
            <p className="text-secondary max-w-800 mx-auto">
              Engineered to detect discrepancies and validate engineering
          ...
          <div className="features-grid">
            <div className="feature-glass-card">
              ...
              <p className="text-secondary text-sm">
                Our AI simulates enterprise ATS logic to rank your resume
                density and formatting accuracy.
              </p>
            </div>
            <div className="feature-glass-card">
              ...
              <p className="text-secondary text-sm">
                We cross-reference every claim in your resume with real
                repository languages and commit history.
              </p>
            </div>
            <div className="feature-glass-card">
              <div className="feature-icon-box">⚠️</div>
              ...
              <p className="text-secondary text-sm">
                Instantly spot inconsistent dates, suspicious skill-stacking,
                and employment timeline gaps.
              </p>
            </div>
          </div>
        </div>
      ...
      {showModal && (
        <div className="modal-overlay auth-wrapper" onClick={closeModal}>
          ...
          <div
            className="modal-content auth-card-premium p-10 rounded-3xl relative"
                    ...
                    <div className="text-center mb-6">
                      <span
                        style={{
                          fontSize: "2rem",
                          fontWeight: "800",
                          color: otpTimer > 10 ? "var(--accent)" : "#ef4444", // 10 sec se kam pe red ho jayega
                          letterSpacing: "4px",
                        }}
                      >
                        {/* Format timer ko as it is rehne do ya direct timer dikhao */}
                        {otpTimer > 0
                  ...
                  <p className="text-secondary text-sm px-4">
                    {isRegister
                      ? formData.githubHandle
                        ...
                        : "Connect your GitHub to validate your skills and build trust."
                ...
                {isRegister && (
                  <div className="flex-center mb-6">
                    <label className="auth-toggle-pill">
                      ...
                      />
                      <span
                        className={`text-xs font-bold ${formData.isRecruiter ? "text-accent" : "text-muted"}`}
                      >
                ...
                {!isRegister || formData.isRecruiter ? (
                  <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <Button
                      ...
                      fullWidth
                      loading={loading}
                      className="py-4 mt-6 shadow-indigo-500/10"
                    >
                    ...
                    {formData.githubHandle ? (
                      ...
                      <div className="space-y-4">
                        ...
                        <div className="auth-trust-list">
                          <div className="trust-item-p">
                            <span>✓</span> Secure OAuth via GitHub
                          </div>
                          <div className="trust-item-p">
                            <span>✓</span> No password stored
                          </div>
                          <div className="trust-item-p">
                            <span>✓</span> Read-only access to public repo data
                          </div>
                        </div>
                      </div>
                    )}
